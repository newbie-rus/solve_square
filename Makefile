...
CXXFLAGS = -D_DEBUG -ggdb3 -std=c++17 -O0 -Wall -Wextra -Weffc++ -Waggressive-loop-optimizations -Wc++14-compat \
...
# leak,nonnull-attribute,null,object-size,return,returns-nonnull-attribute,shift,signed-integer-overflow,undefined,unreachable,\
# vla-bound,vptr
...
OBJ = $(patsubst $(SRC_PREFIX)%.cpp, $(OBJ_PREFIX)%.o, $(SRC))

release : SolveSquareUser

test : UPGRADE_FLAGS SolveSquareTest
...
clean :
	rm $(OBJ_PREFIX)*.o SolveSquareTest SolveSquareUser -R docs/html
