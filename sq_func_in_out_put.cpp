...
// TODO naming
// I suggest to use square_io_funstions / square_input_output
...
void input_coefficient (char name, long double* coefficient)
{
    ...
    // TODO use enum in this switch
    // TODO OR you can just coeffitients[name - 'a'] = coeff;
...
int output_roots (int solutions, long double* roots)
{
    ...
    {
        printf ("строка: %d\nфункция: %s\n", __LINE__, __func__ ); 
        //TODO PlEaSe UsE DeFiNeS iNsTeAd oF cOpyPasTing
